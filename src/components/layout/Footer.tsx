                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <a href="https://wa.me/593995020929" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-green-500 transition-colors">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <Link to="/motorcycles?category=Deportiva" className="text-gray-400 hover:text-primary-400 transition-colors text-sm">
                                    Deportivas
                                </Link>
                            </li>
                            <li>
                                <Link to="/motorcycles?category=Cruiser" className="text-gray-400 hover:text-primary-400 transition-colors text-sm">
                                    Cruiser
                                </Link>
                            </li>
                            <li>
                                <Link to="/motorcycles?category=Touring" className="text-gray-400 hover:text-primary-400 transition-colors text-sm">
                                    Touring
                                </Link>
                            </li>
                        </ul>
