...
export default function Home() {
    return (
        <div>
            ...
            {/* Features Section */}
            <section className="py-8 sm:py-16 md:py-24 bg-dark-900 relative">
                {/* Decorative Elements */}
                ...
                <div className="container-custom px-3 sm:px-6">
                    <div className="text-center mb-8 sm:mb-12 md:mb-16">
                        <h2 className="text-2xl sm:text-3xl md:text-5xl font-display font-bold mb-2 sm:mb-3 md:mb-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
                        <Card variant="glass" hover className="p-4 sm:p-6 md:p-8 text-center group">
                            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-dark-800 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300 border border-dark-700 group-hover:border-primary-500/30 shadow-lg">
                                <svg className="w-10 h-10 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                            </div>
                            <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 sm:mb-3 md:mb-4 text-white group-hover:text-primary-400 transition-colors">Calidad Garantizada</h3>
                        ...
                        <Card variant="glass" hover className="p-8 text-center group">
                            ...
                            <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 sm:mb-3 md:mb-4 text-white group-hover:text-accent-blue transition-colors">Mejores Precios</h3>
                            <p className="text-gray-400 text-sm sm:text-base leading-relaxed">
                        ...
                        <Card variant="glass" hover className="p-8 text-center group">
                            ...
                            <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 sm:mb-3 md:mb-4 text-white group-hover:text-accent-orange transition-colors">Soporte Total</h3>
                            <p className="text-gray-400 text-sm sm:text-base leading-relaxed">
            ...
            <section className="py-12 sm:py-16 md:py-24 relative overflow-hidden">
                ...
                <div className="container-custom relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 sm:gap-8 md:gap-12 px-3 sm:px-6">
                    <div className="text-center md:text-left max-w-2xl">
                        <h2 className="text-2xl sm:text-3xl md:text-5xl font-display font-bold text-white mb-3 sm:mb-4 md:mb-6">
                    ...
                    <div className="flex-shrink-0">
                        <Button to="/motorcycles" className="bg-dark-900 text-white hover:bg-dark-800 border border-white/20 text-base sm:text-lg px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-5 shadow-2xl">
                            Explorar Catálogo
                        </Button>
                    </div>
                </div>
